...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='employee',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='company.employee', verbose_name="Employee's knowledge level"),
        ),
        migrations.AddField(
            model_name='languageknowledgelevel',
            name='language',
        ...
        migrations.AddField(
            model_name='employee',
            name='languages',
            field=models.ManyToManyField(related_name='languages', related_query_name='languages', through='company.LanguageKnowledgeLevel', to='company.Language'),
        ),
        migrations.AddField(
            model_name='employee',
            name='skills',
