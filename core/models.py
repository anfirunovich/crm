...
class Location(CreatedAt, SoftDelete, UpdatedAt):
    ...
    country = CountryField(verbose_name="Location's country", null=False, blank=False)
    city = models.CharField(max_length=255, verbose_name="Location's city", null=False, blank=False)
